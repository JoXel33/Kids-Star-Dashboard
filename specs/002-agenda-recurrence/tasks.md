...
- [ ] T030 [P] Run the manual smoke-test checklist in [quickstart.md](quickstart.md) end-to-end on a real browser at 1366×768; capture any layout regressions (especially: popover staying within viewport, no full-page scroll introduced) *(deferred — needs a human running the dashboard at 1366×768 to confirm no layout regressions)*
